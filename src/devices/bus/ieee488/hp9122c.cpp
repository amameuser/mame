...
private:
	...
	static constexpr int REG_STATUS_DUAL = 1 << 3;
	static constexpr int REG_STATUS_TEST = 1 << 4;
	static constexpr int REG_STATUS_DISKCHG = 1 << 5;
	static constexpr int REG_STATUS_LOW_DENSITY = 1 << 7;
...
DEFINE_DEVICE_TYPE_PRIVATE(GPIB_HP9122C, device_ieee488_interface, hp9122c_device, "hp9122c", "HP9122C Dual High density disk drive")
